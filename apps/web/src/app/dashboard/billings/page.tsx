              ...
              {invoices?.map((invoice: any, index: number) => (
                <tr key={invoice.id}>
                  ...
                  {invoice.status === 'Paid' || invoice.status === 'Expired' ? (
                    <td className="px-4 py-2 border text-gray-100 text-center">
                      <Link
                        href={`/dashboard/billings/${invoice.id}`}
                        className="text-white bg-gray-700 cursor-not-allowed pointer-events-none px-4 py-1 rounded-md"
                        aria-disabled
                      >
                        Pay
                      </Link>
                    ...
                    <td className="px-4 py-2 border text-gray-100 text-center">
                      <Link
                        href={`/dashboard/billings/${invoice.id}`}
                        className="text-white bg-teal-600 hover:bg-green-600 px-4 py-1 rounded-md"
                        aria-disabled
                      >
                        Pay
                      </Link>
